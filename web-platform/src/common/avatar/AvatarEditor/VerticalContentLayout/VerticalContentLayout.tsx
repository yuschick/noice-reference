...
export function VerticalContentLayout({
  avatarParts,
  avatarComposition,
  selectedCategory,
  currency,
  ...
  return (
    <div className={styles.verticalContentLayoutWrapper}>
      <div className={styles.verticalLayoutItemsWrapper}>
        <div
          className={styles.verticalLayoutItemsScroller}
          ref={scrollRef}
        >
          <CategoryContent
      ...
      <div className={styles.categoriesContainer}>
        <div className={styles.categoriesContent}>
          ...
          <CategorySelect
            categories={categories.filter(
              (category) => category.tab === AvatarTab.Outfit,
            )}
            selectedCategory={selectedCategory.type}
            onCategorySelected={handleCategoryChange}
          />
