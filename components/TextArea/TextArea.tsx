    ...
    return (
      ...
      >
        <div className={inputStyles.inputAndSlotsWrapper}>
          <label className={inputStyles.inputLabelWrapper} htmlFor={textAreaId}>
            <textarea
              {...htmlAttributes}
              aria-describedby={
                error?.message ? errorMsgId : `${hintId} ${countId}`
              }
              aria-invalid={!!error?.message}
              className={classNames(styles.textArea, inputStyles.inputField, {
                [styles.multiline]:
                  htmlAttributes.rows && htmlAttributes.rows > 1,
        ...
        {(!!description || showCharacterCount || !!error?.message) && (
          <div
            className={classNames(
              styles.belowInput,
              inputStyles.inputSecondaryWrapper
            )}
          >
            {!!description && (
              <div
