...
type Props = Omit<HTMLButtonAttributes, "role" | "tabIndex" | "type"> &
  ButtonIconPositions & {
    isDisabled?: boolean;
    isLoading?: boolean;
    theme?: "dark" | "light";
...
export const PopoverMenuButton = forwardRef<
  HTMLButtonElement,
  WithChildren<Props>
>(function PopoverMenuButton(
  ...
  if (!context) {
    throw new Error(
      "PopoverMenu.Button can only be used within a PopoverMenu."
    );
  }
