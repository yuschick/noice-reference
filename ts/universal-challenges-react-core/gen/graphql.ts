...
export type UniversalChallengesRandomQueryForCodegenToPassQueryVariables = Exact<{ [key: string]: never; }>;


export type UniversalChallengesRandomQueryForCodegenToPassQuery = { __typename?: 'Query', profileBatch?: { __typename?: 'ProfileBatchGetProfilesResponse', profiles: Array<{ __typename?: 'ProfileProfile', userId: string }> } | null };


export const UniversalChallengesRandomQueryForCodegenToPassDocument = gql`
...
/**
 * __useUniversalChallengesRandomQueryForCodegenToPassQuery__
 *
 * To run a query within a React component, call `useUniversalChallengesRandomQueryForCodegenToPassQuery` and pass it any options that fit your needs.
 * When your component renders, `useUniversalChallengesRandomQueryForCodegenToPassQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUniversalChallengesRandomQueryForCodegenToPassQuery({
 *   variables: {
 *   },
 * });
 */
export function useUniversalChallengesRandomQueryForCodegenToPassQuery(baseOptions?: Apollo.QueryHookOptions<UniversalChallengesRandomQueryForCodegenToPassQuery, UniversalChallengesRandomQueryForCodegenToPassQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UniversalChallengesRandomQueryForCodegenToPassQuery, UniversalChallengesRandomQueryForCodegenToPassQueryVariables>(UniversalChallengesRandomQueryForCodegenToPassDocument, options);
      }
export function useUniversalChallengesRandomQueryForCodegenToPassLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UniversalChallengesRandomQueryForCodegenToPassQuery, UniversalChallengesRandomQueryForCodegenToPassQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UniversalChallengesRandomQueryForCodegenToPassQuery, UniversalChallengesRandomQueryForCodegenToPassQueryVariables>(UniversalChallengesRandomQueryForCodegenToPassDocument, options);
        }
export type UniversalChallengesRandomQueryForCodegenToPassQueryHookResult = ReturnType<typeof useUniversalChallengesRandomQueryForCodegenToPassQuery>;
export type UniversalChallengesRandomQueryForCodegenToPassLazyQueryHookResult = ReturnType<typeof useUniversalChallengesRandomQueryForCodegenToPassLazyQuery>;
export type UniversalChallengesRandomQueryForCodegenToPassQueryResult = Apollo.QueryResult<UniversalChallengesRandomQueryForCodegenToPassQuery, UniversalChallengesRandomQueryForCodegenToPassQueryVariables>;