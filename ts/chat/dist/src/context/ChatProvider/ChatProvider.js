...
const usePollChatProfiles_hook_1 = require("./hooks/usePollChatProfiles.hook");
...
function ChatProvider({ streamChatId, groupChatId, channelId, children }) {
    ...
    (0, _chat_hooks_1.useBlockedUserMessageDeletion)(streamChatId, channelId !== null && channelId !== void 0 ? channelId : null);
    (0, _chat_hooks_1.useBlockedUserMessageDeletion)(groupChatId !== null && groupChatId !== void 0 ? groupChatId : null, channelId !== null && channelId !== void 0 ? channelId : null);
    ...
    (0, usePollChatProfiles_hook_1.usePollChatProfiles)({
        messages: [...streamChat.messages, ...groupChat.messages],
        channelId,
    });
    (0, react_1.useEffect)(() => {
