...
import { EmojiDefinition } from '@chat-types';
export declare const parseEmojisFromMessage: (message: string, emojiDefs: EmojiDefinition[], fromIndex?: number, result?: Required<TextMessageAttachment>[]) => Required<TextMessageAttachment>[];
export declare const getChatMessageText: <T extends Partial<{
                            ...
                            users: (Partial<{
                                ...
                                activity?: Partial<{
                                    ...
                                    channel?: Partial<{
                                        ...
                                        state: Partial<import("@chat-gen").ApiEntityState>;
...
export declare const generateEmojiImg: (emoji: EmojiDefinition) => string;
