...
exports.useChatEmotesAndMentions = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const client_1 = require("@apollo/client");
const react_1 = require("react");
const ChatEmoji_1 = require("../components/ChatEmoji");
function useChatEmotesAndMentions({ message, attachments, ownPlayerName, mentionClassName, emojiClassName, }) {
    ...
    const splitTextToNodesByMention = (text) => {
        ...
        textNodeIndex.current++;
        // Add mention
        nodes.push((0, jsx_runtime_1.jsx)("span", Object.assign({ className: mentionClassName }, { children: searchString }), `mention:${mentionNodeIndex.current}`));
    ...
    const getMessageNodes = () => {
        ...
        attachments.forEach((attachment) => {
            ...
            // Inject the emoji
            messageNodesInternal.push((0, jsx_runtime_1.jsx)(ChatEmoji_1.ChatEmoji, { className: emojiClassName, emote: attachment.label, source: attachment.source }, `emoji:${attachment.startIndex}:${attachment.endIndex}`));
...
exports.useChatEmotesAndMentions = useChatEmotesAndMentions;
useChatEmotesAndMentions.fragments = {
    attachment: (0, client_1.gql) `
    fragment UseChatEmotesAndMentionsAttachment on ChatTextMessageAttachment {
      label
      source
      startIndex
      endIndex
...
//# sourceMappingURL=useChatEmotesAndMentions.hook.js.map