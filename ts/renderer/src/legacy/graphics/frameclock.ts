...
export class FrameClockHandler implements OnRenderHandler {
  private _clock: THREE.Clock = new THREE.Clock();
  private _renderClock: THREE.Clock = new THREE.Clock();
  ...
  public get renderFrame(): boolean {
  ...
  public onPreRender({ dynamicFrameLimiter }: PreRenderProps): void {
