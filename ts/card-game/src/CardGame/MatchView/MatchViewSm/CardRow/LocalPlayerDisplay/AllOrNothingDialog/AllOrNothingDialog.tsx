...
export function AllOrNothingDialog({
  ...
  return (
    <div
      className={classNames(styles.aonDialogRoot, className)}
      style={
        {
    ...
    >
      <div className={styles.aonDialogHeader}>
        <AllOrNothingPending
          aonState={aonState}
          className={styles.aonDialogCard}
        />
        <div className={styles.aonDialogInfo}>
          <h3 className={styles.aonDialogTitle}>Play card again?</h3>
          <p className={styles.aonDialogDescription}>
            You will not score any points if card fails
          </p>
        </div>
      </div>
      <div className={styles.aonDialogActions}>
        <Button
          level="secondary"
          size="sm"
          onClick={() => onPlayAgain()}
        ...
        <p className={styles.aonDialogDescription}>Increase points to {nextPoints}</p>

        <div className={styles.aonDialogDivider} />
        <div className={styles.aonDialogProgressWrapper}>
          <Button
            level="secondary"
            size="sm"
            onClick={() => onCollect()}
          ...
          <div className={styles.aonDialogButtonProgress} />
        </div>
        <p className={styles.aonDialogDescription}>Autocollecting in {animatedValue}</p>
      </div>
    </div>
  );
}
