...
import { ActiveBoosterDialogContent, Props } from './ActiveBoosterDialogContent';

import { BoosterType } from '@game-types';

export default {
  title: 'ActiveBoosterDialogContent',
  component: ActiveBoosterDialogContent,
} as Meta<typeof ActiveBoosterDialogContent>;
