...
export declare enum AchievementConfigCounterRuleDefaultType {
...
type BaseFilter = {};
export type Filter = BaseFilter & OneOf<{
    game: FilterGame;
...
export declare function routeFilterFilterDelegate<C>(ctx: C, val: Filter, delegate: IFilterFilterDelegate<C>): void;
...
export {};
//# sourceMappingURL=achievement.pb.d.ts.map