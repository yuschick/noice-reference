...
export declare enum ArenaConfigArenaType {
...
export declare enum ArenaConfigRenderSettingsSkyboxMode {
...
export declare enum ArenaConfigRenderSettingsAmbientMode {
...
export declare enum ArenaConfigRenderSettingsFogMode {
...
//# sourceMappingURL=config.pb.d.ts.map