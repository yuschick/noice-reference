...
export type Event = BaseEvent & OneOf<{
    eventTrustChanged: EventEventTrustChanged;
    eventFlooding: EventEventFlooding;
    customEvent: EventCustomEvent;
}>;
...
export {};
//# sourceMappingURL=classification.pb.d.ts.map