...
import * as ChallengeChallenge from "../challenge/challenge.pb"
...
export enum MetagameConfigCardBundleConfigType {
...
export type MetagameConfig = {
  ...
  challengeConfigs?: ChallengeChallenge.ChallengeConfig[]
  challengeRewards?: ChallengeChallenge.ChallengeReward[]
