...
export type NotificationItem = {
  ...
  amount?: Amount
  additionalData?: {[key: string]: GoogleProtobufStruct.Value}
  reason?: string
...
export class AdyenProxyService {
  static CreateNotification(req: CreateNotificationRequest, initReq?: fm.InitReq): Promise<GoogleApiHttpbody.HttpBody> {
    return fm.fetchReq<CreateNotificationRequest, GoogleApiHttpbody.HttpBody>(`/v1/adyen/notifications`, {...initReq, method: "POST", body: JSON.stringify(req)})
  }
}