...
export enum RewardDescriptionPrizeDescriptionKind {
...
export type PlacementRewardPrize = BasePlacementRewardPrize
  & OneOf<{ currency: PlacementRewardPrizeCurrency; experiencePoints: PlacementRewardPrizeExperiencePoints }>
...
export function routePlacementRewardPrizeContentDelegate<C>(ctx: C, val: PlacementRewardPrize, delegate: IPlacementRewardPrizeContentDelegate<C>) {
...
export class PlacementsService {
  static GetPlacement(req: GetPlacementRequest, initReq?: fm.InitReq): Promise<GetPlacementResponse> {
    return fm.fetchReq<GetPlacementRequest, GetPlacementResponse>(`/v1/placements/${req["placementId"]}?${fm.renderURLSearchParams(req, ["placementId"])}`, {...initReq, method: "GET"})
  }
  static RewardPlacement(req: RewardPlacementRequest, initReq?: fm.InitReq): Promise<GoogleProtobufEmpty.Empty> {
    return fm.fetchReq<RewardPlacementRequest, GoogleProtobufEmpty.Empty>(`/v1/placements/${req["placementId"]}/reward`, {...initReq, method: "POST", body: JSON.stringify(req)})
  }
}