...
const signupRoutes: SignupRoutes = {
  signupRootRoute: AppRoutes.PopoutSignin,
  errorRoute: `${AppRoutes.PopoutSignin}/${LoginSubRoutes.Error}`,
  suspensionRoute: AppRoutes.Suspended,
  [SignupStage.CompleteAccount]: '',
  [SignupStage.VerifyEmail]: `${AppRoutes.PopoutSignin}/${LoginSubRoutes.VerifyEmail}`,
