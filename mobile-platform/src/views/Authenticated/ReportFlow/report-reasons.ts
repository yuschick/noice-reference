import { SupportReportContext, SupportReportReason } from '@gen/graphql';
...
export interface ContextInfo {
  name?: keyof Omit<SupportReportContext, 'user' | 'channel'>;
}
...
const LivestreamTree: ReasonTree<TreeNode[]> = {
  ...
  nodes: [
    ...
    {
      label:
        'This livestream contains content that is disturbing or shouldn’t be on Noice',
      subtree: ViolativeContentSubtree,
    },
    {
      label:
        'This livestream is failing to moderate its chat according to their own rules',
      subtree: ViolativeContentSubtree,
    },
    {
...
export const Livestream = {
  label: 'In the livestream',
  subtree: LivestreamTree,
  context: {
    placeSpecifiedByUser: ReportType.Livestream,
  },
};
export const Chat = {
  label: 'In the chat',
  subtree: ChatTree,
  context: { placeSpecifiedByUser: ReportType.ChannelChat },
};
